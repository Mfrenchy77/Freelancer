...
/**
 * This is the main screen in Freelancer. User can update their daily log, add new clients, view
 * client list, view all log entries, goto settings and start a timed session //todo add save functionality
 */
